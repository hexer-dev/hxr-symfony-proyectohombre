 ...
 */
final class Version20240307093539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE program (id INT AUTO_INCREMENT NOT NULL, headquarter_id INT NOT NULL, code VARCHAR(150) NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, date_start DATE NOT NULL, date_end DATE NOT NULL, UNIQUE INDEX UNIQ_92ED778477153098 (code), INDEX IDX_92ED778473478E8C (headquarter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
